...
class HandDetector:
    ...
    def data_prep(self):        
        ...
        train_dataset, val_dataset = train_test_split(self.fracture_datas , test_size=0.2, random_state=42)
        ...
        train_dataset, val_dataset = train_test_split(self.hand_datas, test_size=0.2, random_state=42)
    ...
    def detect_hand(self, dir_path='ip_data/scaphoid_detection/images'):
    ...
    def plot_xyxyxyxyn(xyxyxyxyn, image_path, save_path, color=(0, 255, 0)):
        image = cv2.imread(image_path)
